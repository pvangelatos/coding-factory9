 ...
 * Το απόλυτο ενός ακεραίου είναι θετικός
 * αριθμός. Για παράδειγμα, το απόλυτο του -5
 * είναι 5 και το απόλυτο του 5 είναι 5.
 */
...
//
        ...
        System.out.printf("Το απόλυτο του %d είναι το: %d", num, abs);
