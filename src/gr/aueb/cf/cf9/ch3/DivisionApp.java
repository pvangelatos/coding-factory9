...
/**
 * Ο χρήστης εισάγει δύο τιμές, αριθμητή και παρονομαστή και το
 * πρόγραμμα υπολογίζει το πηλίκο, επαναληπτικά
 *
 * Αν ο αριθμητής είναι 0 το πρόγραμμα διακόπτεται.
 * Αν ο παρονομαστής είναι 0, τοτε η διαδικασία επαναλαμβάνεται.
 */
